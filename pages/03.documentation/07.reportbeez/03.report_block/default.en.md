...
>>>>>>you can open this report directly from your MailBeez Dashboard when clicking on the legend "opt-out" of the "Beez-O-Graph" widget.
...
>>>>>Opt-out tracking & reporting only works in simulation mode when configured properly. Please go to **Configuration tab > Simulation > ”Edit” > Enable Tracking in Simulation Mode** and set it to “True”.
